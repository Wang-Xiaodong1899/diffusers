...
from nuscenes_dataset_for_cogvidx import NuscenesDatasetAllframesFPS10OneByOneForCogvidx
...
def main(args):
    ...
    transformer = CogVideoXTransformer3DModel.from_pretrained(
        "/data/wangxd/ckpt/cogvideox-A4-clean-image-inject-f25-fps10-1222-fbf-noaug/checkpoint-500/",
    ...
    # NOTE Attention
    # NOTE if use pretrained_model_name_or_path, use following code, other comment this!
    ...
    train_dataset = NuscenesDatasetAllframesFPS10OneByOneForCogvidx(
