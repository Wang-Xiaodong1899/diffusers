...
from opendv_dataset_for_cogvidx import OpenDVFPS1fbfForCogvidx
...
def main(args):
    ...
    def encode_video(video):
        ...
        if args.given_frames == 1:
            ...
            image_latent_dist = torch.cat(frames_latent, dim=2) # frame by frame
    ...
    train_dataset = OpenDVFPS1fbfForCogvidx(
