...
def main(
    ...
    for tgt_dir in tgt_dirs:
        if os.path.basename(tgt_dir) == "interpolation":
            num_tgt_dir = os.path.join(os.path.dirname(tgt_dir), "interpolation-f2-e7") # seek files in this, then find the first clip
        else:
            num_tgt_dir = os.path.join(tgt_dir, "interpolation-f2-e7")
    ...
    print(f'Ours FVD: {fvd_score}, {fvd_score_0}, {fvd_score_1}, {fvd_score_2}')
