...
def get_args():
    ...
    parser.add_argument(
        "--input_fft",
        action="store_true",
        help="replace image latent as input fft"
    )
...
def main(args):
    ...
    transformer = CogVideoXTransformer3DModel.from_pretrained(
        ...
        "/data/wangxd/ckpt/cogvideox-A4-clean-image-inject-f13-fps1-0109-fbf-fft-inputfft/checkpoint-400",
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                if args.input_fft:
                    image_latent = fourier_filter(image_latent)
