...
transformer = CogVideoXTransformer3DModel.from_pretrained(
        "/data/wangxd/ckpt/cogvideox-A4-clean-image-inject-f13-fps1-0110-fbf-fft-inputfft-resume-0109/checkpoint-1200",
...
while True:
    ...
    export_to_video(total_frames, os.path.join(dir, f"{name_prefix}_cfg_{guidance_scale}_inject_fbf_roll_{rollout}_fps1-0110-fbf-fft-input-fft-1200.mp4"), fps=8)
