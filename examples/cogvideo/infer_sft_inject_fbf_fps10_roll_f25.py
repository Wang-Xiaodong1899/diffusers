...
transformer = CogVideoXTransformer3DModel.from_pretrained(
        "/data/wangxd/ckpt/cogvideox-A4-clean-image-inject-f25-fps10-0113-fbf-noaug/checkpoint-4000",
...
while True:
    ...
    export_to_video(total_frames, os.path.join(dir, f"{name_prefix}_cfg_{guidance_scale}_inject_fbf_fps10_roll_{rollout}_noaug_f25_4000.mp4"), fps=8)