...
transformer = CogVideoXTransformer3DModel.from_pretrained(
        ...
        "/data/wangxd/ckpt/cogvideox-A4-clean-image-input-fft-distill-gan-0110/checkpoint-100/fake_unet",
...
save_dir = "./infer_results/input-fft-distill-gan-0110_100"
...
export_to_video(all_frames, os.path.join(save_dir, f"seed_{seed}_roll_{rollouts}_{name_prefix}_0110-gan-100_cfg_{guidance_scale}_{name_end}.mp4"), fps=8)