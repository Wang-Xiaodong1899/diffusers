...
transformer = CogVideoXTransformer3DModel.from_pretrained(
        ...
        "/data/wangxd/ckpt/cogvideox-A4-clean-image-fft-ckpt-distill-explicit-L2-DDIM-0114/checkpoint-50",
...
while True:
    ...
    export_to_video(total_frames, os.path.join(dir, f"{name_prefix}_cfg_{guidance_scale}_inject_fbf_roll_{rollout}_fft-ckpt-distill-explicit-L2-DDIM-0115-50.mp4"), fps=8)
