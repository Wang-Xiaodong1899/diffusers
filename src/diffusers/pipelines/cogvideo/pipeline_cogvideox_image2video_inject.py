...
class CogVideoXImageToVideoPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    def __call__(
        ...
        latent_channels = self.transformer.config.in_channels // 2 if not self.inject else self.transformer.config.in_channels
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.transformer(
                    ...
                    return_dict=False,
                    image_latent=image_latents if self.inject else None
                )[0]
