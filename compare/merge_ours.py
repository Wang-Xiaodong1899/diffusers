...
def merge_videos(fps):
    ...
    output_dir = "29-0002" # TODO
    
    os.makedirs(output_dir, exist_ok=True)
    mp4_paths = ['29-0002-ours.mp4', '29-0002-ours-continue1.mp4', '29-0002-ours-continue2.mp4'] # TODO
    frames = []
    ...
    # export to video
    export_to_video(frames, os.path.join(output_dir, f"ours_long.mp4"), fps=8)
